...
import kotlinx.android.synthetic.main.to_do_list_layout.*
...
class TodoListActivity:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list_view_to_do.adapter=arrayAdapter
        ...
        list_view_to_do.setOnItemClickListener { adapterview,view,i,l->
            Toast.makeText(applicationContext,todoList[i],Toast.LENGTH_LONG).show()
        }
        list_view_to_do.setOnItemLongClickListener { adapterView, view, i, l ->
